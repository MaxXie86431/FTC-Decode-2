...
@Configurable
@Autonomous(name = "NextFTC Pedro Auto Blue")
public class NextFTCPedroAutoBlue extends NextFTCOpMode {
    ...
    private static final Pose outtatheWayPose = new Pose(50,60,315);
